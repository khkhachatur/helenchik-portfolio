...
return (
    <>
      ...
      <a 
        ...
        className="fixed top-4 md:top-10 left-4 md:left-10 min-[1440px]:left-[calc((100vw-1440px)/2+40px)] z-[80] group flex items-center mix-blend-difference shrink-0"
      >
        <div className="text-[#F5E1D9] md:text-[#DC2626] hover:text-black md:hover:text-white hover:bg-[#F5E1D9] md:hover:bg-[#DC2626] transition-all duration-300 font-mono uppercase tracking-widest text-[10px] sm:text-xs md:text-sm bg-black/20 px-3 py-2 md:px-4 backdrop-blur-md border border-[#F5E1D9]/50 md:border-[#DC2626]/50 shadow-[0_0_15px_rgba(220,38,38,0.2)] whitespace-nowrap">
          {pathname === '/support' ? (
            <>
      ...
      <button 
        ...
        className="fixed top-4 md:top-10 right-4 md:right-10 min-[1440px]:right-[calc((100vw-1440px)/2+40px)] z-[80] group flex items-center gap-3 mix-blend-difference shrink-0"
      >
        ...
        <div className="text-[#F5E1D9] hover:text-[#DC2626] hover:bg-[#F5E1D9]/10 transition-colors font-mono uppercase tracking-widest text-[10px] sm:text-xs md:text-sm bg-black/20 px-3 py-2 md:px-4 backdrop-blur-md border border-[#F5E1D9]/20 whitespace-nowrap">
          [ Menu ]
        </div>
      </button>
